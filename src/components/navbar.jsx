      ...
      <div className="navbar mx-auto max-w-6xl px-4">
        <div className="navbar-start">
          <div className="dropdown">
            <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden" aria-label="Menú">
...
<div className="size-auto overflow-hidden rounded-full bg-white">
  ...
  />
        ...
        <div className="navbar-end gap-2">
          <a href="#contacto" className="btn btn-ghost btn-sm hidden sm:inline-flex">
          ...
          >
            <div className="indicator">
              {totalItems > 0 && (
                <span className="badge indicator-item badge-xs badge-accent">{totalItems}</span>
              )}
